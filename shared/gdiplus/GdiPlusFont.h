...
{
    GpFont *font = NULL;
    lastResult = fn_GdipCreateFontFromDC(hdc, &font);
           ...
           IN const HFONT hfont)
{
    ...
    if (hfont)
    {
        ...
        if(fn_GetObjectA(hfont, sizeof(LOGFONTA), &lf))
            lastResult = fn_GdipCreateFontFromLogfontA(hdc, &lf, &font);
        else
            lastResult = fn_GdipCreateFontFromDC(hdc, &font);
    }
    else
           ...
           IN const LOGFONTA* logfont)
{
    ...
    if (logfont)
    {
        lastResult = fn_GdipCreateFontFromLogfontA(hdc, logfont, &font);
    }
    else
    {
        lastResult = fn_GdipCreateFontFromDC(hdc, &font);
