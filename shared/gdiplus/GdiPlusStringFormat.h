...
public:
    ...
    {
        nativeFormat = NULL;
        lastError = fn_GdipCreateStringFormat(
            formatFlags,
            language,
            &nativeFormat
        );
    ...
    ~StringFormat()
    {
        fn_GdipDeleteStringFormat(nativeFormat);
    }
    ...
    {
        return SetStatus(fn_GdipSetStringFormatAlign(
            nativeFormat,
            align
        ));
    }
    ...
    {
        return SetStatus(fn_GdipSetStringFormatLineAlign(
            nativeFormat,
            align
        ));
    }
