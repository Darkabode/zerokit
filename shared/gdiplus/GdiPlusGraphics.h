...
public:
    ...
    Graphics(IN HDC hdc)
    {
        ...
        lastResult = fn_GdipCreateFromHDC(hdc, &graphics);
    ...
    ~Graphics()
    {
        fn_GdipDeleteGraphics(nativeGraphics);
    }
    ...
    {
        return SetStatus(fn_GdipSetTextRenderingHint(nativeGraphics,
                                                          newMode));
    }
    ...
    {
        return SetStatus(fn_GdipDrawString(
            nativeGraphics,
            string,
            length,
