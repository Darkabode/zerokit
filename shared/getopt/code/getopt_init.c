/* Perform additional initialization for getopt functions in GNU libc.
   ...
   This file is part of the getopt Library.
   Contributed by Ulrich Drepper <drepper@cygnus.com>, 1997.

   Taken from the GNU C Library.
   Windows DLL interface for getopt added by Motama GmbH

   The getopt Library is free software; you can redistribute it and/or
   modify it under the terms of the GNU Lesser General Public
   License as published by the Free Software Foundation; either
   version 2.1 of the License, or (at your option) any later version.

   The getopt Library is distributed in the hope that it will be useful,
   but WITHOUT ANY WARRANTY; without even the implied warranty of
   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
   Lesser General Public License for more details.

   You should have received a copy of the GNU Lesser General Public
   License along with the getopt Library; if not, write to the Free
