...
#ifndef SYS_REALLOCATOR
#define SYS_REALLOCATOR(ptr, newSz) realloc(ptr, newSz)
#endif // SYS_REALLOCATOR

#ifndef SYS_DEALLOCATOR
#define SYS_DEALLOCATOR(ptr) free(ptr)
#endif // SYS_DEALLOCATOR

#ifndef SYS_ALLOCATORZ
#define SYS_ALLOCATORZ(sz) calloc(1, sz)
#endif // SYS_ALLOCATORZ
