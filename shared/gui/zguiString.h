#ifndef _ZGUI_STRING_H_
#define _ZGUI_STRING_H_

namespace zgui
{

#include "zguiCharacterFunctions.h"
...
#include "zguiCharPointer_UTF8.h"
#include "zguiCharPointer_UTF16.h"
#include "zguiCharPointer_UTF32.h"
#include "zguiCharPointer_ASCII.h"
...
public:
    ...
    */
    ...
    static String charToString(zgui_wchar character);
    ...
    */
    ...
    /** Appends a character at the end of this string. */
    String& operator+= (zgui_wchar characterToAppend);
    ...
    */
    inline bool isEmpty() const                    { return text[0] == 0; }

    /** Returns true if the string contains at least one character.
        Note that there's also an isEmpty() method to help write readable code.
        @see containsNonWhitespaceChars()
    */
    inline bool isNotEmpty() const                 { return text[0] != 0; }
    ...
    /** Case-insensitive comparison with another string. */
    bool equalsIgnoreCase (const wchar_t* other) const;
    ...
    */
    ...
    /** Lexicographic comparison with another string.
        ...
        @returns     0 if the two strings are identical; negative if this string comes before
                     the other one alphabetically, or positive if it comes after it.
    */
    int compareLexicographically (const String& other) const;
    ...
    */
    ...
    /** Tests whether the string begins with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool startsWithChar (zgui_wchar character) const;

    /** Tests whether the string begins with another string.
        If the parameter is an empty string, this will always return true.
        Uses a case-insensitive comparison.
    */
    bool startsWithIgnoreCase (const String& text) const;
    ...
    */
    ...
    /** Tests whether the string ends with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool endsWithChar (zgui_wchar character) const;

    /** Tests whether the string ends with another string.
        If the parameter is an empty string, this will always return true.
        Uses a case-insensitive comparison.
    */
    bool endsWithIgnoreCase (const String& text) const;
    ...
    */
    ...
    /** Tests whether the string contains a particular character.
        Uses a case-sensitive comparison.
    */
    bool containsChar (zgui_wchar character) const;

    /** Tests whether the string contains another substring.
        Uses a case-insensitive comparison.
    */
    bool containsIgnoreCase (const String& text) const;
    ...
    */
    bool containsWholeWord (const String& wordToLookFor) const;
    ...
    */
    bool containsWholeWordIgnoreCase (const String& wordToLookFor) const;
    ...
    /** Finds an instance of another substring if it exists as a distict word.
        ...
        @see indexOfWholeWordIgnoreCase, containsWholeWord
    */
    int indexOfWholeWord (const String& wordToLookFor) const;
    ...
    /** Finds an instance of another substring if it exists as a distict word.
        ...
        @see indexOfWholeWord, containsWholeWordIgnoreCase
    */
    int indexOfWholeWordIgnoreCase (const String& wordToLookFor) const;
    ...
    */
    bool containsAnyOf (const String& charactersItMightContain) const;
    ...
    /** Looks for a set of characters in the string.
        ...
        @returns    Returns false if any of the characters in this string do not occur in
                    ...
                    always be true.
    */
    bool containsOnly (const String& charactersItMightContain) const;
    ...
    */
    bool matchesWildcard (const String& wildcard, bool ignoreCase) const;
    ...
    */
    int indexOfChar (zgui_wchar characterToLookFor) const;
    ...
    /** Searches for a character inside this string.
        ...
        @returns            the index of the first occurrence of the character in this
                            string, or -1 if it's not found.
    */
    int indexOfChar (int startIndex, zgui_wchar characterToLookFor) const;
    ...
    */
    int indexOf (const String& textToLookFor) const;
    ...
    */
    int indexOf (int startIndex, const String& textToLookFor) const;
    ...
    /** Searches for a substring within this string.
        ...
        @returns    the index of the first occurrence of this substring, or -1 if it's not found.
                    If textToLookFor is an empty string, this will always return 0.
    */
    int indexOfIgnoreCase (const String& textToLookFor) const;
    ...
    /** Searches for a substring within this string.
        ...
        @returns                the index of the first occurrence of this substring, or -1 if it's not found.
                                If textToLookFor is an empty string, this will always return -1.
    */
    int indexOfIgnoreCase (int startIndex, const String& textToLookFor) const;

    /** Searches for a character inside this string (working backwards from the end of the string).
        Uses a case-sensitive comparison.
        @returns    the index of the last occurrence of the character in this string, or -1 if it's not found.
    */
    int lastIndexOfChar (zgui_wchar character) const;
    ...
    */
    int lastIndexOf (const String& textToLookFor) const;
    ...
    */
    int lastIndexOfIgnoreCase (const String& textToLookFor) const;
    ...
    */
    ...
    /** Returns the character at this index in the string.
        ...
        @see getCharPointer
    */
    const zgui_wchar operator[] (int index) const;

    /** Returns the final character of the string.
        If the string is empty this will return 0.
    */
    zgui_wchar getLastCharacter() const;
    ...
    */
    ...
    String replaceCharacter (zgui_wchar characterToReplace,
                             zgui_wchar characterToInsertInstead) const;
    ...
    */
    String quoted (zgui_wchar quoteCharacter = '"') const;
    ...
    */
    String paddedLeft (zgui_wchar padCharacter, int minimumLength) const;

    /** Returns a copy of this string with the specified character repeatedly added to its
        end until the total length is at least the minimum length specified.
    */
    String paddedRight (zgui_wchar padCharacter, int minimumLength) const;
    ...
    */
    static String __cdecl formatted (const String formatString, ... );

    //==============================================================================
    // Numeric conversions..

    /** Creates a string containing this signed 32-bit integer as a decimal number.
        @see getIntValue, toHexString
    */
    ...
    /** Creates a string containing this unsigned 32-bit integer as a decimal number.
        @see getIntValue, toHexString
    */
    explicit String (uint32_t decimalInteger);
    ...
    */
    ...
    /** Creates a string containing this signed 64-bit integer as a decimal number.
        @see getLargeIntValue, toHexString
    */
    ...
    */
    int64_t getLargeIntValue() const;
    ...
    */
    ...
    /** Returns the character pointer currently being used to store this string.
        ...
        string changes.
    */
    inline const CharPointerType& getCharPointer() const    { return text; }
    ...
    */
    int copyToUTF8 (CharPointer_UTF8::CharType* destBuffer, int maxBufferSizeBytes) const;
    ...
    */
    int copyToUTF16 (CharPointer_UTF16::CharType* destBuffer, int maxBufferSizeBytes) const;
    ...
    */
    int copyToUTF32 (CharPointer_UTF32::CharType* destBuffer, int maxBufferSizeBytes) const;
    ...
    */
    ...
    size_t getByteOffsetOfEnd() const;
...
/** Concatenates two strings. */
String __stdcall operator+ (zgui_wchar string1,      const String& string2);
...
/** Concatenates two strings. */
String __stdcall operator+ (String string1, zgui_wchar characterToAppend);
...
/** Appends a decimal number at the end of a string. */
String& __stdcall operator<< (String& string1, int64_t number);
/** Appends a decimal number at the end of a string. */
...
bool __stdcall operator== (const String& string1, const String& string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const char* string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const wchar_t* string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const CharPointer_UTF8& string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const CharPointer_UTF16& string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const CharPointer_UTF32& string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator!= (const String& string1, const String& string2);
/** Case-sensitive comparison of two strings. */
bool __stdcall operator!= (const String& string1, const char* string2);
