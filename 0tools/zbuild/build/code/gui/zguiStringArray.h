...
public:
    ...
    */
    ...
    void swapWith (StringArray& other) throw();
    ...
    */
    inline String* begin() const throw()
    {
    ...
    */
    ...
    /** Adds numbers to the strings in the array, to make each string unique.
        ...
        @param postNumberString             this string is appended after any numbers that are added.
                                            ...
                                            brackets around the number.
    */
    void appendNumbersToDuplicates (bool ignoreCaseWhenComparing, bool appendNumberToFirstInstance,
                                    CharPointer_UTF8 preNumberString = CharPointer_UTF8 (0), CharPointer_UTF8 postNumberString = CharPointer_UTF8 (0));
