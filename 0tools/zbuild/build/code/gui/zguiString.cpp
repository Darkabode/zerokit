...
public:
    ...
    {
        StringHolder* const s = reinterpret_cast<StringHolder*>(memalloc(sizeof(StringHolder) - sizeof(CharType) + numBytes));
        s->refCount.value = 0;
    ...
    static inline CharPointerType getEmpty() throw()
    {
    ...
    static size_t getAllocatedNumBytes (const CharPointerType& text) throw()
    {
...
namespace NumberToStringConverters
{
    ...
    static char* numberToString (char* t, const int64_t n) throw()
    {
        *--t = 0;
        int64_t v = (n >= 0) ? n : -n;
    ...
    static char* numberToString (char* t, uint64_t v) throw()
    {
        *--t = 0;
    ...
    static char* numberToString (char* t, const int n) throw()
    {
    ...
    static char* numberToString (char* t, unsigned int v) throw()
    {
        *--t = 0;
...
size_t String::getByteOffsetOfEnd() const throw()
{
    return (size_t) (((char*) text.findTerminatingNull().getAddress()) - (char*) text.getAddress());
}

const zgui_wchar String::operator[] (int index) const throw()
{
    return text [index];
}
...
int64_t String::hashCode64() const throw()
{
    CharPointerType t (text);
    int64_t result = 0;
...
//==============================================================================
bool __stdcall operator== (const String& s1, const String& s2) throw()            { return s1.compare (s2) == 0; }
bool __stdcall operator== (const String& s1, const char* const s2) throw()        { return s1.compare (s2) == 0; }
bool __stdcall operator== (const String& s1, const wchar_t* const s2) throw()     { return s1.compare (s2) == 0; }
bool __stdcall operator== (const String& s1, const CharPointer_UTF8& s2) throw()  { return s1.getCharPointer().compare (s2) == 0; }
bool __stdcall operator== (const String& s1, const CharPointer_UTF16& s2) throw() { return s1.getCharPointer().compare (s2) == 0; }
bool __stdcall operator== (const String& s1, const CharPointer_UTF32& s2) throw() { return s1.getCharPointer().compare (s2) == 0; }
bool __stdcall operator!= (const String& s1, const String& s2) throw()            { return s1.compare (s2) != 0; }
bool __stdcall operator!= (const String& s1, const char* const s2) throw()        { return s1.compare (s2) != 0; }
bool __stdcall operator!= (const String& s1, const wchar_t* const s2) throw()     { return s1.compare (s2) != 0; }
bool __stdcall operator!= (const String& s1, const CharPointer_UTF8& s2) throw()  { return s1.getCharPointer().compare (s2) != 0; }
...
//==============================================================================
int String::indexOfChar (const zgui_wchar character) const throw()
{
    return text.indexOf (character);
}

int String::indexOfChar (const int startIndex, const zgui_wchar character) const throw()
{
    CharPointerType t (text);
...
int String::lastIndexOfChar (const zgui_wchar character) const throw()
{
    CharPointerType t (text);
    int last = -1;
...
int String::indexOfAnyOf (const String& charactersToLookFor, const int startIndex, const bool ignoreCase) const throw()
{
    CharPointerType t (text);
...
int String::indexOf (const String& other) const throw()
{
...
bool String::containsChar (const zgui_wchar character) const throw()
{
...
{
    static bool matches (CharPointer wildcard, CharPointer test, const bool ignoreCase) throw()
    {
        for (;;)
        {
    ...
    static bool characterMatches (const zgui_wchar wc, const zgui_wchar tc, const bool ignoreCase) throw()
    {
        return (wc == tc) || (wc == '?' && tc != 0)
                || (ignoreCase && CharacterFunctions::toLowerCase (wc) == CharacterFunctions::toLowerCase (tc));
    }

    static bool matchesAnywhere (const CharPointer& wildcard, CharPointer test, const bool ignoreCase) throw()
    {
...
bool String::startsWithChar (const zgui_wchar character) const throw()
{
    return *text == character;
}

bool String::endsWithChar (const zgui_wchar character) const throw()
{
    if (text.isEmpty())
        return false;
...
//==============================================================================
zgui_wchar String::getLastCharacter() const throw()
{
...
int64_t String::getLargeIntValue() const throw()
{
...
int64_t String::getHexValue64() const throw()
{
...
{
    static CharPointer_UTF8 convert(const String& source) throw()
    {
...
{
    static CharPointer_UTF16 convert(const String& source) throw()
    {
...
{
    static CharPointer_UTF32 convert(const String& source) throw()
    {
...
int String::copyToUTF32 (CharPointer_UTF32::CharType* const buffer, int maxBufferSizeBytes) const throw()
{
