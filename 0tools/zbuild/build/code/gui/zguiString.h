...
public:
    ...
    */
    ...
    int64_t hashCode64() const throw();
    ...
    */
    ...
    /** Tests whether the string begins with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool startsWithChar (zgui_wchar character) const throw();
    ...
    */
    ...
    /** Tests whether the string ends with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool endsWithChar (zgui_wchar character) const throw();
    ...
    */
    ...
    /** Tests whether the string contains a particular character.
        Uses a case-sensitive comparison.
    */
    bool containsChar (zgui_wchar character) const throw();
    ...
    */
    int indexOfChar (zgui_wchar characterToLookFor) const throw();
    ...
    /** Searches for a character inside this string.
        ...
        @returns            the index of the first occurrence of the character in this
                            string, or -1 if it's not found.
    */
    int indexOfChar (int startIndex, zgui_wchar characterToLookFor) const throw();
    ...
    */
    int lastIndexOfChar (zgui_wchar character) const throw();
    ...
    */
    ...
    /** Returns the character at this index in the string.
        ...
        @see getCharPointer
    */
    const zgui_wchar operator[] (int index) const throw();

    /** Returns the final character of the string.
        If the string is empty this will return 0.
    */
    zgui_wchar getLastCharacter() const throw();
    ...
    */
    int64_t getLargeIntValue() const throw();
    ...
    */
    int64_t getHexValue64() const throw();
...
bool __stdcall operator== (const String& string1, const String& string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const char* string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const wchar_t* string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const CharPointer_UTF8& string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const CharPointer_UTF16& string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator== (const String& string1, const CharPointer_UTF32& string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator!= (const String& string1, const String& string2) throw();
/** Case-sensitive comparison of two strings. */
bool __stdcall operator!= (const String& string1, const char* string2) throw();
